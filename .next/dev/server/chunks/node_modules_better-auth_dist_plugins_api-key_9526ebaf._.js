...
async function validateApiKey({ hashedKey, ctx, opts, schema, permissions }) {
    ...
    if (permissions) {
        const apiKeyPermissions = apiKey.permissions ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__n__as__safeJSONParse$3e$__["safeJSONParse"])(apiKey.permissions) : null;
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/api-key/create", {
        ...
        if (opts.storage === "secondary-storage" && opts.fallbackToDatabase) {
            ...
            const id = ctx.context.generateId({
                model: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$api$2d$key$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_KEY_TABLE_NAME"]
            }) ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__r__as__generateId$3e$__["generateId"])();
            apiKey = {
                ...data,
                id
            };
        ...
        return ctx.json({
            ...
            permissions: apiKey.permissions ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__n__as__safeJSONParse$3e$__["safeJSONParse"])(apiKey.permissions) : null
        });
    });
}
;
...
function getApiKey({ opts, schema, deleteAllExpiredApiKeys }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/api-key/get", {
        ...
        return ctx.json({
            ...returningApiKey,
            permissions: returningApiKey.permissions ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__n__as__safeJSONParse$3e$__["safeJSONParse"])(returningApiKey.permissions) : null
        });
    });
}
;
...
function listApiKeys$1({ opts, schema, deleteAllExpiredApiKeys }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/api-key/list", {
        ...
        const session = ctx.context.session;
        let apiKeys;
        apiKeys = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$api$2d$key$2f$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listApiKeys"])(ctx, session.user.id, opts);
        deleteAllExpiredApiKeys(ctx.context);
        ...
        let returningApiKey = apiKeys.map((x)=>{
            ...
            return {
                ...returningApiKey$1,
                permissions: returningApiKey$1.permissions ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__n__as__safeJSONParse$3e$__["safeJSONParse"])(returningApiKey$1.permissions) : null
            };
        });
